                                            ...
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-20-1.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-20-2.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-19-4.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-19-1.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-18-1.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-18-4.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-17-1.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-17-4.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-16-4.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-16-1.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-15-1.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-15-3.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-14-2.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-14-1.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-13-1.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-13-2.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-12-1.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-12-4.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-11-1.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-11-2.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-10-1.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-10-3.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-9-1.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-9-2.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-8-2.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-8-1.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-7-2.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-7-1.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-6-4.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-6-1.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-5-3.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-5-4.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-4-3.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-4-2.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-3-2.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-3-3.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-2-1.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-2-3.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-1-1.jpg" alt="Product Image" class="primary-image">
                                                            <img src="{{ asset('frontsite') }}/assets/img/products/prod-1-4.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                    ...
                                    <div class="banner-box banner-type-3 banner-type-3-2 banner-hover-1">
                                        <div class="banner-inner">
                                            <div class="banner-image">
                                                <img src="{{ asset('frontsite') }}/assets/img/banner/ad-banner.jpg" alt="Banner">
                                            </div>
