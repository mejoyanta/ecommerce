                        ...
                        <figure class="product-image">
                            <div class="product-image--holder">
                                <a href="{{ route('product.details', $product->id) }}">
                                    ...
                                    <img src="/frontsite/assets/img/products/{{$img->lg_img}}" alt="{{$product->title}}"
                            ...
                            <div class="airi-product-action">
                                <div class="product-action">
                                    <a @click.prevent="showProductModal({{$product}})" class="quickview-btn action-btn"
                                    ...
                                    <a @click.prevent="addItemToCart({{$product->id}})"
                                        class="add_to_cart_btn action-btn" data-toggle="tooltip" data-placement="top"
                                        title="Add to Cart">
