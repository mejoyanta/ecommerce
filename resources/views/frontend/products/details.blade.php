                                        ...
                                        <div class="product-gallery__thumb--image">
                                            ...
                                            "arrowNext_md": "dl-icon-right"
                                                ...
                                                <figure class="product-gallery__thumb--single">
                                                    <img src="{{ asset('frontsite') }}/assets/img/products/prod-19-1-2.jpg" alt="Products">
                                                </figure>
                                                <figure class="product-gallery__thumb--single">
                                                    <img src="{{ asset('frontsite') }}/assets/img/products/prod-19-2-2.jpg" alt="Products">
                                                </figure>
                                                <figure class="product-gallery__thumb--single">
                                                    <img src="{{ asset('frontsite') }}/assets/img/products/prod-19-3-2.jpg" alt="Products">
                                                </figure>
                                                <figure class="product-gallery__thumb--single">
                                                    <img src="{{ asset('frontsite') }}/assets/img/products/prod-19-4-2.jpg" alt="Products">
                                                </figure>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="product-gallery__wrapper">
                                                <div class="main-slider product-gallery__full-image image-popup">
                                                    <figure class="product-gallery__image zoom">
                                                        <img src="{{ asset('frontsite') }}/assets/img/products/prod-19-1-big.jpg" alt="Product">
                                                    </figure>
                                                    <figure class="product-gallery__image zoom">
                                                        <img src="{{ asset('frontsite') }}/assets/img/products/prod-19-2-big.jpg" alt="Product">
                                                    </figure>
                                                    <figure class="product-gallery__image zoom">
                                                        <img src="{{ asset('frontsite') }}/assets/img/products/prod-19-3-big.jpg" alt="Product">
                                                    </figure>
                                                    <figure class="product-gallery__image zoom">
                                                        <img src="{{ asset('frontsite') }}/assets/img/products/prod-19-4-big.jpg" alt="Product">
                                                    </figure>
                                                </div>
